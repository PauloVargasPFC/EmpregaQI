...
<body>
    ...
    <section class="container">
        <div style="text-align:center; padding-top: 15px;">
            <h1>Cadastro de Vaga de emprego</h1>
        </div>
        <div>
            <form>
                ...
                <div class="form-row">
                    <div class="form-group col-md-2.5" style="margin-right: 30px;">
                        <label>Necessário experiência?</label>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>Nível de estudo necessário</label>
                        <select id="inputRelacao2" class="form-control">
                            <option selected disabled value="0">Escolha...</option>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" id="cargah" placeholder="Ex.: 44">
                    </div>
                </div>

                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label>Saláio de remuneração</label>
                        <label>(R$)</label>
                        <input type="number" class="form-control" id="remun" placeholder="Ex.: 1100">
                    </div>
                </div>
                
                <input type="button" class="btn btn-secondary" id="limpar" value="Limpar">
                <input type="submit" class="btn btn-primary" id="Cadastrar" value="Cadastrar">
            </form>
        </div>
    </section>
